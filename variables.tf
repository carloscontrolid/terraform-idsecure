...
variable "trusted_ips" {
  ...
  type        = list(string)
  default     = ["186.240.135.64/32", "56.124.100.2/32", "186.240.135.64/32", "177.84.240.162/32", "177.76.206.204/32", "200.171.205.98/32", "179.193.77.224/32", "187.75.34.21/32", "201.6.116.97/32", "170.0.58.116/32", "179.110.233.166"]
}
